...
<template>
    ...
    <v-menu open-on-hover :close-on-content-click="false">
        ...
        <v-sheet width="300" height="200" elevation="10" rounded="md" class="pa-4 pb-0">
            <div>
                <v-row>
                            ...
                            <div class="pa-5 pl-0">
                                <div class="d-flex align-center justify-space-between">
                                    <router-link to="/" class="text-decoration-none d-flex align-center">
                                        ...
                                        <h6 class="text-subtitle-1 font-weight-bold text-hover-primary ml-2">Frequently
                                            Asked Questions</h6>
                                    </router-link>
    ...
    <v-btn variant="text" color="primary">Active Organization </v-btn>
</template>
