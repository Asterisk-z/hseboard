...
const getOrganizations = computed(() => (organizationStore.loggedUserOrgs));
const getActiveOrganizations = computed(() => (organizationStore.getActiveOrg()));
                                            ...
                                            <router-link :to="'#'" class="text-decoration-none custom-text-primary"
                                                ...
                                                <div class="d-flex align-center">
                                                    ...
                                                    <div class="ml-3">
                                                        ...
                                                        <p class="text-subtitle-2 textSecondary">{{ item.industry?.name }}</p>
                                                    </div>
                                                </div>
                                            </router-link>
                                        </v-col>
