...
class AuditTemplateQuestionSeed extends Seeder
{
    /**
    ...
    public function run()
    {
        ...
        $header = null;
        $topic = null;
        $template = AuditTemplate::where('title', 'HSE Management System Audit')->first();
        foreach ($hse_audit as $audit_type) {

            if (strstr($audit_type, '[GROUP]')) {
                if (AuditTemplateQuestion::where('title', str_replace('[GROUP]', '', $audit_type))->where('audit_template_id', $template->id)->exists()) {
                    continue;
                }
                ...
                if (AuditTemplateQuestion::where('title', str_replace('[HEADER]', '', $audit_type))->where('audit_template_id', $template->id)->exists()) {
                    continue;
                }
                ...
                if (AuditTemplateQuestion::where('title', str_replace('[TOPIC]', '', $audit_type))->where('audit_template_id', $template->id)->exists()) {
                    continue;
                }
                ...
                if (AuditTemplateQuestion::where('question', $audit_type)->where('audit_template_id', $template->id)->exists()) {
                    continue;
                }
        ...
        $header = null;
        $topic = null;
        $template = AuditTemplate::where('title', 'Quality Management Audit')->first();
        ...
        $header = null;
        $topic = null;
        $template = AuditTemplate::where('title', 'Environmental Management System')->first();
